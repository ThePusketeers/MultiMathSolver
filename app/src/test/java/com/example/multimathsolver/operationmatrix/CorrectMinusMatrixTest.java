...
public class CorrectMinusMatrixTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                {new double[][] {{1, 2, 3, 4, 5}, {4, 8, 3, 9, 1}}, new double[][] {{5, 1, 8, 2, 1}, {9, 22, 13, 7, 4}}, new double[][] {{-4, 1, -5, 2, 4}, {-5, -14, -10, 2, -3}}},
                {new double[][] {{4, 2}, {6, 11}}, new double[][] {{15, 5}, {2, 14}}, new double[][] {{-11, -3}, {4, -3}}},
                {new double[][] {{5}}, new double[][] {{7}}, new double[][] {{-2}}},
                {new double[][] {{5, 1, 5}, {8, 14, 23}}, new double[][] {{11, 62, 14}, {451, 4, 9}}, new double[][] {{-6, -61, -9}, {-443, 10, 14}}},
        });
    }
